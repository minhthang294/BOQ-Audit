...
export default function NewJob() {
  const router = useRouter(); const fileRef = useRef<HTMLInputElement>(null); const estimateFileRef = useRef<HTMLInputElement>(null);
  const [filename, setFilename] = useState(""); const [estimateFilename, setEstimateFilename] = useState(""); const [progress, setProgress] = useState(0); const [error, setError] = useState(""); const [loading, setLoading] = useState(false);
